...
describe("build", () => {
  ...
  it.skip("does not allow connection if no player ID is received", async () => {
    const app = build(port);
  ...
  it.skip("adds new player if player ID is received and match has no other players", async () => {
    const app = build(port);
    const server = app.server;
  ...
  it.skip("adds new player if player ID is received and match has other players", async () => {
    const app = build(port);
    const server = app.server;
  ...
  it.skip("does not add new player if player ID is the same as an existing player's", async () => {
    const app = build(port);
    const server = app.server;
